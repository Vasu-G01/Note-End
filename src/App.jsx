    ...
    <div>
      ...
      <div className='h-screen lg:flex bg-gray-100 text-black rounded-[10vh] mt-[10vh]'>
          ...
          <div className='flex gap-2'>
            {colors.map((color, index) => (
              <div
                ...
                className={`w-6 h-6 rounded-full cursor-pointer transition-transform duration-150 ${selectedColor === color ? 'ring-2 ring-black scale-110' : ''
                  }`}
        ...
        <div className='lg:w-1/2 lg:border-l-2'>
          ...
          <div className='flex flex-wrap items-start justify-center lg:justify-start gap-5 mt-6 min-h-[300px] bg-gray-100 rounded-xl p-4'>

            {task.map(function (elem, idx) {
              return (
                <div
                  key={idx}
                  className="flex justify-between flex-col items-start relative h-52 w-40 sm:w-44 rounded-xl text-black pt-9 pb-4 px-4 shadow-md"
